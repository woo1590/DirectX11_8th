...
public:
    static Shader* Create(const _wstring& filePath, const D3D11_INPUT_ELEMENT_DESC* pElement, _uint numElement);
    HRESULT Initialize(const _wstring& filePath, const D3D11_INPUT_ELEMENT_DESC* pElement, _uint numElement);
    ...
    HRESULT SetValue(const _string& name, _float4x4 value){ return S_OK; }
